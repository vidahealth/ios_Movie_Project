...
class MoviePickerVC: UIViewController {
    ...
    private func setupLayout() {
        ...
        let bottomBox = createBox(withText: "Book Prompt - Add a button that opens the calendar view here")
        ...
        NSLayoutConstraint.activate([
            ...
            movieCarouselVC.view.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 4/7),
            ...
            middleBox.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 2/7),
